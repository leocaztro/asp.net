...
/**
 * se captura la session una vez verificado
 * luego se pregunta si es el usuario que ingreso puede vissualizar la pagino si no es lo devuelve a al login
 */
...
if (!isset($usuario)) {
    header("location: ../pagina_login/index.php");
}else {
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Cuenta</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <li><a href="../../controller/crud_implementado/form.php">administrar registro</a></li>
                            <li><a href="../pagina_compra/index.php">ver tienda virtual</a></li>
