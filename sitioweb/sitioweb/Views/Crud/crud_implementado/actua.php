...
$con = conectar();
/**
 * se captura la id y que nos muestre la informacion de esa id para modificar
 */
$id = $_GET['id'];
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="form" role="tabpanel" aria-labelledby="form-tab">
					<div class="card">
						...
						<div class="card-body">
							<form class="form" role="form" autocomplete="off" action="CRUD/update.php" method="POST">
								<div class="form-group row text-center">
									<label class="col-lg-4 col-form-label form-control-label">Codigo semilla:</label>
									<div class="col-lg-6 text-center">
										<input class="form-control" type="text" readonly name="cod" value="<?php echo $row['ID_SEMILLA'] ?>">
									</div>
								</div>
								<div class="form-group row text-center">
